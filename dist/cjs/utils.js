  ...
  _react["default"].Children.toArray(children).forEach(function (item) {
    ...
    if (idx !== -1) {
      ...
      if (typeofIs === "function") {
        ...
        if (fIdx !== -1) {
          ret[fIdx] = /*#__PURE__*/ _react["default"].cloneElement(
            item,
            _objectSpread(
        ...
        if (tIdx !== -1) {
          ret[tIdx] = /*#__PURE__*/ _react["default"].cloneElement(
            item,
            _objectSpread(
              _objectSpread({}, item.props),
              {},
...
var allowedChildren = function allowedChildren(allowedTypes) {
  return function (props, propName, componentName) {
    ...
    var forbidden = _react["default"].Children.toArray(props[propName]).find(
      function (item) {
